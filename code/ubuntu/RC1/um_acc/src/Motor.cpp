...
int main(int argc, char **argv){
	ros::init(argc, argv, "motor_node1");
	ros::NodeHandle nh;
	ros::Publisher motor_pub = nh.advertise<um_acc::Motor_data>("Motor_data1", 1000);
	ros::Subscriber motor_sub = nh.subscribe("Motor_command1", 1, motorCallback);
	ros::Subscriber lidar_sub = nh.subscribe("Lidar_data1", 1, lidarCallback);
